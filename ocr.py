...
if DEBUG:
    # if DEBUG:block to illustrate that we don't need it for our code to work, only for debug purposes
...
# Defining paths for data and test directories
DATA_DIR = "data\\"
TEST_DIR = "test\\"
TEST_DATA_FILENAME = DATA_DIR  + 'Dataset\\devanagari-test-images-idx3-ubyte'
TEST_LABELS_FILENAME = DATA_DIR  + 'Dataset\\devanagari-test-labels-idx1-ubyte'
TRAIN_DATA_FILENAME = DATA_DIR  + 'Dataset\\devanagari-train-images-idx3-ubyte'
TRAIN_LABELS_FILENAME = DATA_DIR + 'Dataset\\devanagari-train-images-idx3-ubyte'
...
def main():
    ...
    if DEBUG:
        ...
        y_test = [5]
        print(f"First training image: {X_train[0][:10]}")  # Sample of the first image's pixels
